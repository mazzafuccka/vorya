...
$output.= '<a href="javascript:void(0);" class="accent-color" style="cursor:default; text-decoration:none;" data-toggle="tooltip" data-original-title="'.__('In your favorites','framework').'"><i class="fa fa-heart"></i></a>';
$output.='</div>';
return $output; }
else{
	 $output='<div class ="favorite_information">';
$output.= '<span class ="favorite"><div class="favorite-strings" style="display:none;"><span class="favorite-title">' . __('Add to Favourite','framework') . '</span><span class="favorite-body">' . __(' Sending Request To Add this Property ...','framework') . '</span><span class="favorite-success">' . __('In your favorites','framework') . '</span></div><a href="#" class="accent-color" style="text-decoration:none;" data-toggle="tooltip" data-original-title="'.__('Add this property to your favorites','framework').'"><i class="fa fa-heart-o"></i></a></span>';
        ...
        <div class="row">
          <div class="col-md-<?php echo $class; ?>">
			...
			$property_area = get_post_meta(get_the_ID(),'imic_property_area',true); 
              ...
              <?php if(!empty($property_term_type)) { ?><span class="area"><strong><?php _e('For','framework'); ?></strong><?php echo $property_term_type; ?></span> <?php } ?>
              <?php if(!empty($property_area)) { ?><span class="area"><strong><?php echo $property_area; ?></strong><?php _e('Area','framework'); ?></span> <?php } ?>
              <?php if(!empty($property_baths)) { ?><span class="baths"><strong><?php echo $property_baths; ?></strong><?php _e('Baths','framework'); ?></span> <?php } ?>
              <?php if(!empty($property_beds)) { ?><span class="beds"><strong><?php echo $property_beds; ?></strong><?php _e('Beds','framework'); ?></span> <?php } ?>
              <?php if(!empty($property_parking)) { ?><span class="parking"><strong><?php echo $property_parking; ?></strong><?php _e('Parking','framework'); ?></span> <?php } ?> <span class="parking"><?php if ( is_plugin_active( 'favorite_property/favorite_property.php' ) ) { if(is_user_logged_in()) { $current_user = wp_get_current_user();
            ...
            <div class="property-grid">
			  ...
			  $property_area = get_post_meta(get_the_ID(),'imic_property_area',true); 
                ...
                <li class="grid-item type-<?php if(!empty($term)) { echo $term->name; } ?>">
                  <div class="property-block"> <a href="<?php the_permalink(); ?>" class="property-featured-image"> <?php the_post_thumbnail('600-400-size'); ?> <span class="images-count"><i class="fa fa-picture-o"></i> <?php echo $total_images; ?></span> <?php if(!empty($term)) { ?><span class="badges"><?php echo $term->name; ?></span><?php } ?> </a>
                    <div class="property-info">
                      <h4><a href="<?php the_permalink(); ?>"><?php echo $property_address; ?></a></h4>
                      <?php if(!empty($property_city)) { echo '<a class="accent-color" data-original-title="'.$sl.'" data-toggle="tooltip" style="cursor:default; text-decoration:none;" href="javascript:void(0);"><span class="location sort_by_location">'.$property_city.'</span></a><br>'; } ?>
                      <?php if(!empty($property_price)) { ?><div class="price"><strong><?php echo $currency_symbol; ?></strong><span><?php echo $property_price; ?></span></div><?php } ?>
                    </div>
                    <div class="property-amenities clearfix"> 
                    <?php if(!empty($property_area)) { ?><span class="area"><strong><?php echo $property_area; ?></strong><?php _e('Area','framework'); ?></span> <?php } ?>
                    <?php if(!empty($property_baths)) { ?><span class="baths"><strong><?php echo $property_baths; ?></strong><?php _e('Baths','framework'); ?></span> <?php } ?>
                    <?php if(!empty($property_beds)) { ?><span class="beds"><strong><?php echo $property_beds; ?></strong><?php _e('Beds','framework'); ?></span> <?php } ?>
                   <?php if(!empty($property_parking)) { ?> <span class="parking"><strong><?php echo $property_parking; ?></strong><?php _e('Parking','framework'); ?></span> <?php } ?></div>
                  </div>
                </li>
