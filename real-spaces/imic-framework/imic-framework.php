...
if (!function_exists('imic_enqueue_scripts')) {
    function imic_enqueue_scripts() {
		...
		wp_register_script('imic_jquery_maphilight', IMIC_THEME_PATH . '/js/jquery.maphilight.js', array(), '', true);
		wp_register_script('imic_jquery_building_map', IMIC_THEME_PATH . '/js/building-map.js', array(), '', true);
        //**End register script**//
        //**Enqueue script**//
		...
		wp_localize_script('imic_jquery_init', 'urlajax', array('url' => admin_url('admin-ajax.php'),'tmpurl' => get_template_directory_uri(),'is_property'=>is_singular('property'),'sticky'=>$sticky_menu,'is_contact'=>is_page_template('template-contact.php'),'home_url'=>  site_url(),'is_payment'=>is_page_template('template-payment.php'),'register_url'=>imic_get_template_url('template-register.php'),'is_register'=>is_page_template('template-register.php'),'is_login'=>is_user_logged_in(),'is_submit_property'=>is_page_template('template-submit-property.php')));
        if (is_singular() && comments_open() && get_option('thread_comments')) {
            wp_enqueue_script('comment-reply');
        }
		wp_enqueue_script('imic_jquery_maphilight');
		wp_enqueue_script('imic_jquery_building_map');
        //**End Enqueue script**//
