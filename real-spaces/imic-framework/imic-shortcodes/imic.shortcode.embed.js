function embedSelectedShortcode() {
	...
	if (current_shortcode != -1) {
		...
		var testimonial_slider= document.getElementById('testimonial-slider').value;
		var testimonial_pagination = document.getElementById('testimonial-pagination').value;
		...
		if (shortcode_select == 'shortcode-testimonial') {
			shortcodeHTML = '<br/>[testimonial number="'+testimonial_count+'" slider="'+testimonial_slider+'" pagination="'+testimonial_pagination+'"]<br/>';	
		}
