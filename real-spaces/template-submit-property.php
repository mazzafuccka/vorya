                                    ...
                                    <div class="row">
                                        ...
                                        if (!empty($property_details_option_enable['6']) == 1) {
                                            ...
                                            <div class="col-md-4 col-sm-4 submit-description">
                                                <textarea name="description" style="resize:vertical" class="form-control margin-0" rows="1" cols="10" placeholder="<?php _e('Property Description', 'framework'); ?>"><?php echo $property_content; ?></textarea>
                                            </div>
                                        <?php } ?>
                                    </div>  
                                    <?php
